...
//                 <Navbar toggleSidebar={toggleSidebar} userName={userName}  openModal={openModal}/>
...
import MealDetail from './components/MealDetail/MealDetail';
import Timer from './components/Timer/Timer';
import WorkoutList from './components/WorkoutList/WorkoutList'; // Importar el componente
import MealList from './components/MealList/MealList'; // Importar el componente
import './App.css';
            ...
            <div className="app-container">
                ...
                <div className="main-content">
                    <Routes>
                        ...
                        <Route path="/create-workout" element={<CreateWorkout />} />
                        <Route path="/create-meal" element={<CreateMeal />} />
                        <Route path="/workouts" element={<WorkoutList workouts={workouts} />} /> {/* Ruta para la lista de entrenamientos */}
                        <Route path="/meals" element={<MealList meals={meals} />} /> {/* Ruta para la lista de comidas */}
