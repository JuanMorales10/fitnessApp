...
//             console.log(data.choices[0].message.content); // Log the content received

//             const workoutHtml = data.choices[0].message.content; // Update this line
//             setWorkout(workoutHtml);

//             const savedWorkouts = JSON.parse(localStorage.getItem('workouts')) || [];
//             localStorage.setItem('workouts', JSON.stringify([...savedWorkouts, workoutHtml]));
//         } catch (error) {
...
//             <div className='fo' >
//                 <h2>Crear Rutina</h2>
//                 <form onSubmit={(e) => { e.preventDefault(); createWorkoutPlan(); }}>
...
//                         dangerouslySetInnerHTML={{ __html: workout }}
//                     ></div>
//                 </div>
//             )}
//         </div>
